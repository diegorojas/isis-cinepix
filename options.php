...
$options[] = array( "name" => __('Custom logo image', 'isis'),
	...
	$options[] = array( "name" => __('Menu', 'isis'),
						"desc" => "Change footer copyright and header  menu background color",
						"id" => "menu_colorpicker",
						"std" => "#191615",
						"type" => "color");
...
$options[] = array( "name" => __('Our Client', 'isis'),
	                   'desc' => __('Image size must be 223px*113px. If you leave this field empty, the our client section will not be displayed.', 'isis'),
					   'type' => 'info'
						); 	
	...
	$options[] = array(
		...
		'desc' => __('<b>Upgrade to Isis PRO for 2 silder with unlimited slider image and customs slider.</b>', 'isis'),
		'type' => 'info');	
...
$options[] = array( "name" => __('Number of Slides', 'isis'),
	...
	$options[] = array(
		...
		'desc' => __('This Slider supports upto 5 Images. To show only 3 Slides in the slider, upload only 3 images. Leave the rest Blank. For best results, upload images of size 1180x500px.<b>Upgrade to Isis PRO for unlimited slider and customs slider</b>', 'options_framework_theme'),
		'type' => 'info');
...
$options[] = array( "name" => __('About the theme', 'isis'),
						"type" => "heading");
