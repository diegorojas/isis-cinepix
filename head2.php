...
<div class="row"> 
 ...
 <div id="branding2">
    	...
    	<!--LOGO START-->
        <div id="site-title2">
        <?php if (of_get_option('osiris_logo_image')) : ?>
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo-img"><img src="<?php echo of_get_option('osiris_logo_image'); ?>" alt="<?php bloginfo( 'name' ); ?>" /></a>
                    <?php else : ?>
